...
impl Entity for WorkCitingCounts { type T = u32; const N: usize = 67024539; const NAME: & str = "work-citing-counts"; }
...
impl Entity for WorkTopSource { type T = u16; const N: usize = 67024539; const NAME: & str = "work-top-source"; }
...
impl Entity for AuthorWorks { type T = Box<[u32]>; const N: usize = 4088379; const NAME: & str = "author-works"; }
...
impl Entity for WorkCountries { type T = Box<[u8]>; const N: usize = 67024539; const NAME: & str = "work-countries"; }
