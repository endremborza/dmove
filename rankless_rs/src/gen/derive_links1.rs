...
impl Entity for WorksCiting { type T = Box<[u32]>; const N: usize = 67024539; const NAME: & str = "works-citing"; }
...
impl Entity for WorkSubfields { type T = Box<[u8]>; const N: usize = 67024539; const NAME: & str = "work-subfields"; }
...
impl Entity for WorkAuthors { type T = Box<[u32]>; const N: usize = 67024539; const NAME: & str = "work-authors"; }
...
impl Entity for WorkInstitutions { type T = Box<[u16]>; const N: usize = 67024539; const NAME: & str = "work-institutions"; }
